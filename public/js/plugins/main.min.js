define("note_info",[],(function(){var t=["<table>","<tr><th>"+getMsg("Create Time")+'</th><td id="noteInfoCreatedTime"></td></tr>',"<tr><th>"+getMsg("Update Time")+'</th><td id="noteInfoUpdatedTime"></td></tr>','<tr class="post-url-tr">',"<th>"+getMsg("Post Url")+"</th>","<td>",'<div class="post-url-wrap">','<span class="post-url-base">http://blog.leanote.com/life/post/</span><span><span class="post-url-text">life-life-life-a-leanote</span>','<input type="text" class="form-control">',"</span>",' <a class="post-url-pencil" title="'+getMsg("update")+'"><i class="fa fa-pencil"></i></a>',"</div>","</td>","</tr>","</table>"].join(""),e=$(t),n=e.find("#noteInfoCreatedTime"),o=e.find("#noteInfoUpdatedTime"),i=(e.find("#noteInfoPostUrl"),e.find(".post-url-tr")),l=e.find(".post-url-wrap"),r=e.find("input"),d=e.find(".post-url-base"),s=e.find(".post-url-text");({$noteInfo:$("#noteInfo"),note:null,bind:function(){var t=this;$("#noteInfoDropdown").click((function(){t.render()})),e.find(".post-url-pencil").click((function(){l.addClass("post-url-edit"),r.val(decodeURI(t.note.UrlTitle)),r.focus()})),r.keydown((function(t){13===t.keyCode&&r.blur()})),r.blur((function(){l.removeClass("post-url-edit");var e=r.val();e&&ajaxPost("/member/blog/updateBlogUrlTitle",{noteId:t.note.NoteId,urlTitle:e},(function(e){if(reIsOk(e)){var n=encodeURI(e.Item);t.note.UrlTitle=n,s.text(decodeURI(t.note.UrlTitle))}else alert(e.Msg||"error")}))})),LEA.on("noteChanged",(function(e){t.render(e)}))},getPostUrl:function(t){return""},rendered:!1,render:function(t){t||(t=Note.getCurNote()),t&&(this.note=t,n.html(goNowToDatetime(t.CreatedTime)),o.html(goNowToDatetime(t.UpdatedTime)),t.IsBlog?(i.removeClass("hide"),d.text(UserInfo.PostUrl+"/"),s.text(decodeURI(t.UrlTitle))):i.addClass("hide"),this.rendered||(this.$noteInfo.html(e),this.rendered=!0))},init:function(){this.bind()}}).init()}));
define("tips",[],(function(){var d=['<div class="modal fade bs-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">','<div class="modal-dialog modal-sm">','<div class="modal-content">','<div class="modal-header">','<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>','<h4 class="modal-title" class="modalTitle">'+getMsg("editorTips")+"</h4>","</div>",'<div class="modal-body">'+getMsg("editorTipsInfo")+"</div>",'<div class="modal-footer">','<button type="button" class="btn btn-default" data-dismiss="modal">'+getMsg("close")+"</button>","</div>","</div>","</div>","</div>"].join(""),a=$(d);(function(){$("#tipsBtn").click((function(){a.modal({show:!0})}))})()}));
define("history",[],(function(){var t=['<div class="modal fade history-modal" tabindex="-1" role="dialog" aria-hidden="true">','<div class="modal-dialog modal-lg ">','<div class="modal-content">','<div class="modal-header">','<h4 class="modal-title" class="modalTitle">NaN',"</div>",'<div class="modal-body clearfix">','<div class="history-list-wrap pull-left">','<div class="history-list-header">'+getMsg("history")+' (<span class="history-num"></span>)</div>','<div class="history-list list-group"></div>',"</div>",'<div class="history-content-wrap pull-left">','<div class="history-content-header">','<a class="btn btn-primary back">'+getMsg("restoreFromThisVersion")+"</a>",'<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>',"</div>",'<div class="history-content"></div>',"</div>","</div>",'<div class="modal-footer hide">','<button type="button" class="btn btn-default" data-dismiss="modal">'+getMsg("close")+"</button>","</div>","</div>","</div>","</div>"].join(""),i=$(t),s=i.find(".history-content"),e=i.find(".history-list"),n=i.find(".history-num");({note:null,list:[],curIndex:0,renderContent:function(t){var i=this.list[t].Content;this.curIndex=t;var n="<div>",o="</div>";this.note.IsMarkdown&&(n="<pre>",o="</pre>",i=trimTitle(i)),s.html(n+i+o);var a=e.find("a");a.removeClass("active"),a.eq(t).addClass("active")},render:function(t){var s="";if(this.list=t,t)for(var o=0;o<t.length;++o){var a=t[o];s+='<a class="list-group-item" data-index="'+o+'"><span class="badge">#'+(o+1)+"</span>"+goNowToDatetime(a.UpdatedTime)+"</a>"}e.html(s),this.renderContent(0),n.html(t.length),i.modal({show:!0})},bind:function(){var t=this;$("#contentHistory").click((function(){t.getHistories()})),e.on("click","a",(function(){var i=$(this).data("index");t.renderContent(i)})),i.find(".back").click((function(){confirm(getMsg("confirmBackup"))&&(Note.curChangedSaveIt(!0),note=Note.cache[Note.curNoteId],setEditorContent(t.list[t.curIndex].Content,note.IsMarkdown),i.modal("hide"),Note.curChangedSaveIt(!0))}))},getHistories:function(){var t=this,i=Note.getCurNote();t.note=i,ajaxGet("/noteContentHistory/listHistories",{noteId:Note.curNoteId},(function(i){isArray(i)?t.render(i):alert(getMsg("noHistories"))}))},init:function(){this.bind()}}).init()}));
var urlPrefix=UrlPrefix;define("attachment_upload",["fileupload"],(function(){function e(e){return"number"!=typeof e?"":e>=1e9?(e/1e9).toFixed(2)+" GB":e>=1e6?(e/1e6).toFixed(2)+" MB":(e/1e3).toFixed(2)+" KB"}var t,a;t="#uploadAttach",a=$("#dropAttach"),$(t).bind("dragover",(function(e){e.preventDefault();var t=window.dropZoneTimeoutAttach;t&&clearTimeout(t);var o=!1,i=e.target;do{if(i===a[0]){o=!0;break}i=i.parentNode}while(null!=i);o?a.addClass("hover"):a.removeClass("hover"),window.dropZoneTimeoutAttach=setTimeout((function(){window.dropZoneTimeoutAttach=null,a.removeClass("in hover")}),100)}));!function(){$(".dropzone .btn-choose-file").click((function(){$(this).parent().find("input").click()}));var t=$("#attachUploadMsg");$("#uploadAttach").fileupload({dataType:"json",pasteZone:"",dropZone:$("#dropAttach"),formData:function(e){return[{name:"noteId",value:Note.curNoteId}]},add:function(a,o){var i=Note.getCurNote();if(i&&!i.IsNew){var l=$('<div class="alert alert-info"><img class="loader" src="/images/ajax-loader.gif"> <a class="close" data-dismiss="alert">×</a></div>');l.append(o.files[0].name+" <small>[<i>"+e(o.files[0].size)+"</i>]</small>"),t.html(l),o.context=t;var n=o.files[0].size,r=+GlobalConfigs.uploadAttachSize||100;if("number"==typeof n&&n>1048576*r)return l.find("img").remove(),l.removeClass("alert-info").addClass("alert-danger"),l.append(" Warning: File size is bigger than "+r+"M"),void setTimeout(function(e){return function(){e.remove()}}(l),3e3);setTimeout((function(){o.submit()}),10)}else alert("This note hasn't saved, please save it firstly!")},done:function(t,a){if(1==a.result.Ok)a.context.html(""),Attach.addAttach(a.result.Item);else{a.result;a.context.html("");var o=$('<div class="alert alert-danger"><a class="close" data-dismiss="alert">×</a></div>');o.append("<b>Error:</b> "+a.files[0].name+" <small>[<i>"+e(a.files[0].size)+"</i>]</small> "+a.result.Msg),a.context.html(o),setTimeout(function(e){return function(){e.remove()}}(o),3e3)}$("#uploadAttachMsg").scrollTop(1e3)},fail:function(t,a){a.context.html("");var o=$('<div class="alert alert-danger"><a class="close" data-dismiss="alert">×</a></div>');o.append("<b>Error:</b> "+a.files[0].name+" <small>[<i>"+e(a.files[0].size)+"</i>]</small> "+a.errorThrown),a.context.html(o),setTimeout(function(e){return function(){e.remove()}}(o),3e3),$("#uploadAttachMsg").scrollTop(1e3)}})}()}));
define("editor_drop_paste",["fileupload"],(function(){function e(e){var t,i,o="__mcenew"+(new Date).getTime(),a='<div contenteditable="false" id="'+o+'" class="leanote-image-container"><img class="loader" src="/images/ajax-loader.gif"><div class="progress"><div class="progress-bar progress-bar-success progress-bar-striped" role="progressbar" aria-valuenow="2" aria-valuemin="0" aria-valuemax="100" style="width: 0%;">0%</div></div></div>';this.containerStr=a,e.insertContent(a),t=$("#editorContent").children(),(i=t&&t.length>0?t[t.length-1]:null)&&"P"==i.tagName||$("#editorContent").append('<p><br data-mce-bogus="1"></p>');var n=$("#"+o);this.container=n,this.id=o,this.processBar=n.find(".progress-bar")}function t(e,t){var i=document.createElement("img");function o(e,o){i.parentNode.removeChild(i),t({width:e,height:o})}i.onload=function(){o(i.clientWidth,i.clientHeight)},i.onerror=function(){o()},i.src=e;var a=i.style;a.visibility="hidden",a.position="fixed",a.bottom=a.left=0,a.width=a.height="auto",document.body.appendChild(i)}e.prototype.update=function(e){(e=Math.ceil(100*e))>=100&&(e=99),e+="%",$("#"+this.id+" .progress-bar").html(e).css("width",e)},e.prototype.replace=function(e){var i=this;t(e,(function(){$("#"+i.id).replaceWith('<img src="'+e+'" />')}))},e.prototype.remove=function(){$("#"+this.id).remove()};var i=1;var o,a,n=0;!function(){var e=$("#upload ul");function o(e){return"number"!=typeof e?"":e>=1e9?(e/1e9).toFixed(2)+" GB":e>=1e6?(e/1e6).toFixed(2)+" MB":(e/1e3).toFixed(2)+" KB"}$("#drop a").click((function(){$(this).parent().find("input").click()})),$("#upload").fileupload({dataType:"json",pasteZone:"",acceptFileTypes:/(\.|\/)(gif|jpg|jpeg|png|jpe)$/i,maxFileSize:21e4,dropZone:$("#drop"),formData:function(e){return[{name:"albumId",value:""}]},add:function(t,i){var a=$('<li><div class="alert alert-info"><img class="loader" src="/images/ajax-loader.gif"> <a class="close" data-dismiss="alert">×</a></div></li>');a.find("div").append(i.files[0].name+" <small>[<i>"+o(i.files[0].size)+"</i>]</small>"),i.context=a.appendTo(e);i.submit()},done:function(e,a){if(1==a.result.Ok){a.context.remove(),function(e){var o=tinymce.activeEditor.dom,a=function(a){var n,r={};r.id="__mcenew"+i++,r.src="/images/loading-24.gif",n=o.createHTML("img",r),tinymce.activeEditor.insertContent(n),n=o.get(r.id),t(e.src,(function(e){o.setAttrib(n,"src",a.src),a.title&&o.setAttrib(n,"title",a.title),o.setAttrib(n,"id",null)}))},n="";if(fileIds=e.src.split("fileId="),2==fileIds.length&&fileIds[1].length=="53aecf8a8a039a43c8036282".length&&(n=fileIds[1]),n){var r=Note.getCurNote();r&&r.UserId!=UserInfo.UserId?function(e){ajaxPost("/file/copyImage",{userId:UserInfo.UserId,fileId:n,toUserId:r.UserId},(function(t){reIsOk(t)&&t.Id&&(e.src="/api/file/getImage?fileId="+t.Id),a(e)}))}(e):a(e)}else a(e)}({src:"/api/file/getImage?fileId="+a.result.Id})}else{a.context.empty();var n=$('<li><div class="alert alert-danger"><a class="close" data-dismiss="alert">×</a></div></li>');n.find("div").append("<b>"+getMsg("Error")+":</b> "+a.files[0].name+" <small>[<i>"+o(a.files[0].size)+"</i>]</small> "+a.result.Msg),a.context.append(n),setTimeout(function(e){return function(){e.remove()}}(n),2e3)}$("#uploadMsg").scrollTop(1e3)},fail:function(e,t){t.context.empty();var i=$('<li><div class="alert alert-danger"><a class="close" data-dismiss="alert">×</a></div></li>');i.find("div").append("<b>"+getMsg("Error")+":</b> "+t.files[0].name+" <small>[<i>"+o(t.files[0].size)+"</i>]</small> "+t.errorThrown),t.context.append(i),setTimeout(function(e){return function(){e.remove()}}(i),2e3),$("#uploadMsg").scrollTop(1e3)}}),$(document).on("drop dragover",(function(e){e.preventDefault()})),$(document).bind("dragover",(function(e){var t=$("#drop"),i=window.dropZoneTimeout;i?clearTimeout(i):(t.addClass("in"),function(){$("#upload").css("z-index",12);var e=+$("#mceToolbar").css("height").slice(0,-2);$("#upload").css("top",e-8),$("#upload").show()}());var o=!1,a=e.target;do{if(a===t[0]){o=!0;break}a=a.parentNode}while(null!=a);o?(t.addClass("hover"),LEA.readOnly&&LEA.toggleWriteable()):t.removeClass("hover"),window.dropZoneTimeout=setTimeout((function(){window.dropZoneTimeout=null,t.removeClass("in hover"),$("#upload").css("z-index",0).css("top","auto").hide()}),500)}))}(),$("#editorContent, #left-column").fileupload({dataType:"json",pasteZone:$("#editorContent, #left-column"),dropZone:"",maxFileSize:21e4,url:"/file/pasteImage",paramName:"file",formData:function(e){return[{name:"from",value:"pasteImage"},{name:"noteId",value:Note.curNoteId}]},progress:function(e,t){o&&!o.IsMarkdown&&t.process.update(t.loaded/t.total)},add:function(t,i){var r=(new Date).getTime();if(!(r-n<500)){n=r;var s=Note.getCurNote();o=s,!s||s.IsNew,setTimeout((function(){if(a=tinymce.EditorManager.activeEditor,!s.IsMarkdown)var t=new e(a);i.process=t,i.submit()}),20)}},done:function(e,t){if(1==t.result.Ok){var i="/api/file/getImage?fileId="+t.result.Id;o&&!o.IsMarkdown?t.process.replace(i):MD&&MD.insertLink(i,"title",!0)}else t.process.remove()},fail:function(e,t){o&&!o.IsMarkdown&&t.process.remove()}})}));
